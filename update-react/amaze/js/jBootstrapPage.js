        ...
        return this.each(function() {
            ...
            function init() {
        		...
        		for(var index = 1; index <= pageCount; index++) {
        			pNum++;
        			$this.append('<li class="page" pNum="'+pNum+'" style="display:none" ><a href="#" page="'+index+'">'+index+'</a></li>');
        		}
            ...
            function mathPrePage(currButtonNum, currPage, maxPage, showPage) {
            	...
            	if(currButtonNum != currPage && currButtonNum < middle) {
            		...
            		for(var index = startPages; index <= endPages; index++) {
            			pNum++;
            			html += '<li class="page" pNum="'+pNum+'" style="display:none"><a href="#" page="'+index+'">'+index+'</a></li>';
            		}
